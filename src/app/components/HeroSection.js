      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center">
          ...
          >
            ...
            >
              Recomendaciones personalizadas de lugares para visitar, comer,
              comprar y más, todo seleccionado por locales que conocen mejor.
            </motion.p>
            ...
            >
              {["100K+ Usuarios", "50K+ Lugares", "120+ Ciudades"].map(
                (stat, index) => (
                  <motion.span
                    key={stat}
          ...
          <motion.div className="md:w-1/2 mb-10 md:mb-0 pl-8">
          <motion.div className="relative">
            {/* First image (larger) */}
            <motion.div
              className="bg-white rounded-2xl shadow-xl overflow-hidden p-1"
            ...
            <motion.div
              className="absolute -bottom-10 -left-4 bg-white rounded-2xl shadow-xl overflow-hidden w-56 h-56 p-1"
