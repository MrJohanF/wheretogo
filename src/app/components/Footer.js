        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          <div className="col-span-2 lg:col-span-2">
            ...
            <p className="mb-4 text-sm">
              Descubre las mejores experiencias locales con recomendaciones personalizadas de lugares para visitar, comer, comprar y explorar.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/safety" className="hover:text-white">Centro de Seguridad</Link></li>
              <li><Link href="/community" className="hover:text-white">Normas de la Comunidad</Link></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6 text-sm">
            <div className="flex items-center">
              ...
              <a href="mailto:hello@localist.com" className="hover:text-white">soporte@localist.com</a>
            </div>
            <div className="flex items-center">
              <Phone className="h-4 w-4 mr-2" />
              <a href="tel:+15551234567" className="hover:text-white">(+57) 317 800 0000</a>
            </div>
          </div>
        </div>
      </div>
