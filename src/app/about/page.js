...
export default function AboutPage() {
  ...
  const team = [
    ...
    },
    {
      ...
      bio: "Diseñadora UX/UI con pasión por crear experiencias digitales hermosas y funcionales que deleiten a los usuarios.",
      image: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?ixlib=rb-4.0.3&auto=format&fit=crop&w=256&q=80"
    },
    {
      name: "Miguel Fernández",
      role: "Jefe de Contenido",
      bio: "Experto en gastronomía y cultura local. Supervisa la calidad y autenticidad de las recomendaciones en la plataforma.",
