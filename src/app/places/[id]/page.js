...
import { 
  ...
  ChevronLeft, ChevronRight, Calendar, Users, X, Share2,
  Navigation, ExternalLink, Menu, Info, MessageCircle,
  Image as ImageIcon, Check, MapPinned, Coffee, ThumbsUp,
  CircleCheck, CircleDashed, Upload, Bookmark
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-[60vh] bg-gray-900">
        ...
        <div className="absolute top-6 left-0 right-0 px-4 sm:px-6 flex justify-between items-center z-10">
        ...
        <div className="absolute bottom-6 left-0 right-0 px-6 flex justify-between items-center">
          ...
          <button
            ...
            className="px-4 py-2 bg-white/90 hover:bg-white rounded-lg transition-colors text-sm font-medium shadow-md flex items-center"
          >
              ...
              <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <div className="flex items-start">
                        <MapPin size={20} className="mr-3 text-indigo-600 mt-0.5 flex-shrink-0" />
                        <div>
                          <h4 className="font-medium text-gray-900">Ubicación</h4>
                          <p className="text-gray-600">{mockPlace.address}</p>
                          <a href={`https://maps.google.com/?q=\${mockPlace.address}`} target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:text-indigo-800 text-sm font-medium flex items-center mt-1">
                      ...
                      <div className="flex items-start">
                        <Phone size={20} className="mr-3 text-indigo-600 mt-0.5 flex-shrink-0" />
                        <div>
                          <h4 className="font-medium text-gray-900">Contacto</h4>
                          <p className="text-gray-600">{mockPlace.phone}</p>
                          <a href={`tel:\${mockPlace.phone.replace(/\s/g, '')}`} className="text-indigo-600 hover:text-indigo-800 text-sm font-medium flex items-center mt-1">
                      ...
                      <div className="flex items-start">
                        <Globe size={20} className="mr-3 text-indigo-600 mt-0.5 flex-shrink-0" />
                        <div>
                          <h4 className="font-medium text-gray-900">Sitio web</h4>
                          <a href={mockPlace.website} target="_blank" rel="noopener noreferrer" className="text-indigo-600 hover:text-indigo-800 break-all">
                            {mockPlace.website}
                          </a>
                        </div>
                      </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    {Object.entries(mockPlace.schedule).map(([day, hours], index) => (
                      <div 
                        key={day} 
                ...
                <div className="h-64 bg-gray-100 relative">
                  <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    <div className="text-center">
                      <MapPinned size={32} className="mx-auto text-indigo-500 mb-2" />
                  ...
                  <div className="flex flex-col sm:flex-row gap-6 bg-indigo-50 p-4 rounded-xl mb-8">
                    ...
                    <div className="flex-1">
                      ...
                      {[5, 4, 3, 2, 1].map((rating) => {
                        ...
                        const count = mockPlace.reviews.filter(r => Math.floor(r.rating) === rating).length;
                      ...
                      <div key={review.id} className="border border-gray-100 rounded-xl p-4 hover:shadow-sm transition-shadow">
                        <div className="flex items-start justify-between">
                          ...
                          <div className="flex items-center bg-gray-50 px-2 py-1 rounded">
                            ...
                            <span className="ml-1 font-medium text-gray-700">{review.rating}</span>
                          </div>
                        </div>
                  ...
                  <div className="space-y-4 mb-4">
                    <div className="flex items-center text-sm text-gray-700">
                      ...
                      {mockPlace.openNow ? (
                        ...
                        <span className="text-red-700 font-medium">Cerrado</span>
                      )}
                    </div>
                    <div className="flex items-center text-sm text-gray-700">
                ...
                <div className="space-y-4">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="flex items-start">
                      ...
                      <div className="ml-3">
                        <h4 className="font-medium text-gray-900">Restaurante {i}</h4>
                        <div className="flex items-center text-sm text-gray-500">
          ...
          >
            <div className="bg-black/90 p-4 flex items-center justify-between">
              <div className="text-white font-medium">
                {galleryView === 'single' && (
                  <span>{currentImageIndex + 1} de {mockPlace.images.length} fotos</span>
                )}
                {galleryView === 'grid' && (
              ...
              <div className="flex items-center space-x-4">
                <button
                  onClick={() => setGalleryView(galleryView === 'single' ? 'grid' : 'single')}
                  ...
                  <div className="p-6 max-h-[70vh] overflow-y-auto">
                    <form onSubmit={handleBookingSubmit} className="space-y-4">
                      ...
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            onChange={(e) => setBookingData({ ...bookingData, guests: Math.min(20, Math.max(1, parseInt(e.target.value))) })}
                            className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                          />
                        </div>
                      </div>
                      ...
                      <div className="border-t border-gray-200 my-4 pt-4">
                        <h4 className="font-medium text-gray-800 mb-3">Tus datos</h4>
